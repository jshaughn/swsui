...
import { MeshGraphData } from 'pages/MeshGraph/MeshGraphPage';

type MeshCyGraphProps = {
  ...
  onNodeDoubleTap?: (e: MeshGraphNodeDoubleTapEvent) => void;
  onNodeTap?: (e: MeshGraphNodeTapEvent) => void;
...
export type MeshGraphNodeTapEvent = {
  isInaccessible: boolean;
};

export type MeshGraphNodeDoubleTapEvent = MeshGraphNodeTapEvent & {};

// exporting this class for testing
export default class MeshCytoscapeGraph extends React.Component<MeshCyGraphProps> {
  static contextTypes = {
    router: () => null
  };
  static defaultProps = {};
  ...
  constructor(props: MeshCyGraphProps) {
    super(props);
  ...
  shouldComponentUpdate(nextProps: MeshCyGraphProps) {
  ...
  componentDidUpdate(prevProps: MeshCyGraphProps) {
